...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('envelope_companycontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.SmallIntegerField')(default=2)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='envelope_companycontact_created_by_', null=True, to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='envelope_companycontact_updated_by_', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('envelope', ['CompanyContact'])

        # Adding model 'ProductContact'
        db.create_table('envelope_productcontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.SmallIntegerField')(default=2)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='envelope_productcontact_created_by_', null=True, to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='envelope_productcontact_updated_by_', null=True, to=orm['auth.User'])),
            ('user_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Company'])),
            ('contact_company', self.gf('django.db.models.fields.TextField')()),
            ('contact_job_title', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('envelope', ['ProductContact'])

        # Adding model 'SolutionContact'
        db.create_table('envelope_solutioncontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.SmallIntegerField')(default=2)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='envelope_solutioncontact_created_by_', null=True, to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='envelope_solutioncontact_updated_by_', null=True, to=orm['auth.User'])),
            ('user_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Company'])),
            ('contact_company', self.gf('django.db.models.fields.TextField')()),
            ('contact_job_title', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('envelope', ['SolutionContact'])


    def backwards(self, orm):
        # Deleting model 'CompanyContact'
        db.delete_table('envelope_companycontact')

        # Deleting model 'ProductContact'
        db.delete_table('envelope_productcontact')

        # Deleting model 'SolutionContact'
        db.delete_table('envelope_solutioncontact')
    ...
    models = {
        ...
        'companies.brochure': {
            'Meta': {'ordering': "['order']", 'object_name': 'Brochure', '_ormbases': ['companies.Resource']},
            'resource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['companies.Resource']", 'unique': 'True', 'primary_key': 'True'})
        },
        'companies.company': {
        ...
        'companies.companytopic': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'companies_companytopic_tagged_items'", 'to': u"orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'companies_companytopic_items'", 'to': "orm['articles.Topics']"})
        },
        ...
        'companies.image': {
            'Meta': {'ordering': "['order']", 'object_name': 'Image', '_ormbases': ['companies.Resource']},
            'resource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['companies.Resource']", 'unique': 'True', 'primary_key': 'True'})
        },
        'companies.membership': {
            'Meta': {'ordering': "['order']", 'object_name': 'Membership', '_ormbases': ['companies.Resource']},
            'resource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['companies.Resource']", 'unique': 'True', 'primary_key': 'True'})
        },
        'companies.operationareas': {
        ...
        'companies.video': {
            'Meta': {'ordering': "['order']", 'object_name': 'Video', '_ormbases': ['companies.Resource']},
        ...
        'envelope.companycontact': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'envelope_companycontact_created_by_'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_box': ('django.db.models.fields.TextField', [], {}),
            'state': ('django.db.models.fields.SmallIntegerField', [], {'default': '2'}),
            'subject': ('django.db.models.fields.TextField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'envelope_companycontact_updated_by_'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'user_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'})
        },
        'envelope.productcontact': {
            ...
            'contact_phone': ('phonenumber_field.modelfields.PhoneNumberField', [], {'max_length': '128'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'envelope_productcontact_created_by_'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_box': ('django.db.models.fields.TextField', [], {}),
            'state': ('django.db.models.fields.SmallIntegerField', [], {'default': '2'}),
            'subject': ('django.db.models.fields.TextField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'envelope_productcontact_updated_by_'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'user_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'})
        },
        'envelope.solutioncontact': {
            ...
            'contact_phone': ('phonenumber_field.modelfields.PhoneNumberField', [], {'max_length': '128'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'envelope_solutioncontact_created_by_'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_box': ('django.db.models.fields.TextField', [], {}),
            'state': ('django.db.models.fields.SmallIntegerField', [], {'default': '2'}),
            'subject': ('django.db.models.fields.TextField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'envelope_solutioncontact_updated_by_'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'user_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'})
        },
        'filer.file': {
            ...
            'folder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'all_files'", 'null': 'True', 'to': u"orm['filer.Folder']"}),
        ...
        'filer.folder': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['filer.Folder']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'uploaded_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
