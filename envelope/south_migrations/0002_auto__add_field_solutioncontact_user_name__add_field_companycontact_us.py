...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('envelope_solutioncontact', 'user_name',
                      self.gf('django.db.models.fields.TextField')(default='no user name'),
                      keep_default=False)

        # Adding field 'CompanyContact.user_name'
        db.add_column('envelope_companycontact', 'user_name',
                      self.gf('django.db.models.fields.TextField')(default='no user name'),
                      keep_default=False)

        # Adding field 'ProductContact.user_name'
        db.add_column('envelope_productcontact', 'user_name',
                      self.gf('django.db.models.fields.TextField')(default='no user name'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('envelope_solutioncontact', 'user_name')

        # Deleting field 'CompanyContact.user_name'
        db.delete_column('envelope_companycontact', 'user_name')

        # Deleting field 'ProductContact.user_name'
        db.delete_column('envelope_productcontact', 'user_name')
